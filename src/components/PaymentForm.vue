...
const emits = defineEmits(['update:bookingConfirmed', 'cancel']);

const products = ref(1);
const payment = ref('');

const paymentMethods = [
  { id: 'CREDIT_CARD', label: 'Credit Card', icon: 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z' },
  ...
  { id: 'GOOGLE_PAY', label: 'Google Pay', icon: 'M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A13.916 13.916 0 008 11a4 4 0 118 0c0 1.017-.07 2.019-.203 3m-2.118 6.844A21.88 21.88 0 0015.171 17m3.839 1.132c.645-2.266.99-4.659.99-7.132A8 8 0 008 4.07M3 15.364c.64-1.319 1-2.8 1-4.364 0-1.457.39-2.823 1.07-4' },
  { id: 'BANK_TRANSFER', label: 'Bank ', icon: 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z' }
];
...
const incrementQuantity = () => {
  if (products.value < props.number) {
    products.value++;
  }
};
...
<template>
  <div class="flex justify-center items-center">
    <div class="w-128 h-144 rounded-xl shadow-2xl flex flex-col items-center justify-center bg-white p-8 m-4">
        ...
        <div class="px-8 rounded-lg">
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center rounded-lg tablet:mb-0">
              ...
              <!-- NUMBER -->
              <input type="number" v-model="products" min="1" :max="props.number"
      ...
      <div class="w-96 flex space-x-4">
        <button @click="$emit('cancel')" class="relative overflow-hidden bg-white py-3 text-dark-gray font-bold w-full rounded-xl shadow-xl
        ...
        <button @click="submitBooking" class="relative overflow-hidden bg-black-gray py-3 text-white font-bold w-full rounded-xl shadow-xl
                       transition-all duration-300 ease-in-out
